 ...
 * @author rafae
 */
public class consultarPassagens extends javax.swing.JFrame {

    /**
     * Creates new form consultarPassagens
     */
    public consultarPassagens() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(consultarPassagens.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new consultarPassagens().setVisible(true);
            }
        });
    }
