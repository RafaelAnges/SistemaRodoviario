...
public class usuario extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        Alterar.setFont(new java.awt.Font("Tahoma", 1, 10)); // NOI18N
        ...
        jLayeredPane1.setLayer(Alterar, javax.swing.JLayeredPane.DEFAULT_LAYER);
    ...
    private void AlterarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_AlterarActionPerformed
        if (!alterarUsuario.getInstancia().isVisible()) {
            alterarUsuario.getInstancia().setVisible(true);
        } else {
            alterarUsuario.getInstancia().requestFocus();
        }
